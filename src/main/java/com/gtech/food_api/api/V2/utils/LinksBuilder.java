...
import com.gtech.food_api.api.V1.controller.GroupPermissionController;
import com.gtech.food_api.api.V1.controller.KitchenController;
import com.gtech.food_api.api.V1.controller.OrderController;
import com.gtech.food_api.api.V1.controller.PaymentMethodController;
import com.gtech.food_api.api.V1.controller.PermissionController;
import com.gtech.food_api.api.V1.controller.ProductController;
import com.gtech.food_api.api.V1.controller.ProductFileController;
import com.gtech.food_api.api.V1.controller.ReportController;
import com.gtech.food_api.api.V1.controller.RestaurantController;
import com.gtech.food_api.api.V1.controller.RestaurantPaymentMethodController;
import com.gtech.food_api.api.V1.controller.RestaurantResponsibleController;
import com.gtech.food_api.api.V1.controller.StateController;
import com.gtech.food_api.api.V1.controller.StatusOrderController;
import com.gtech.food_api.api.V1.controller.UserController;
import com.gtech.food_api.api.V1.controller.UserGroupController;
...
public class LinksBuilder {
    ...
    public Link linkToReports(String rel) {
        return linkTo(ReportController.class).withRel(rel);
    }
    ...
    public Link linkToReportsVendasDiarias(String rel) {
        ...
        String pedidosUrl = linkTo(methodOn(ReportController.class)
    ...
    */
    ...
    public Link linkToGroups() {
        return linkTo(GroupController.class).withRel("groups");
    }
    ...
    public Link linkToPermissions() {
        return linkTo(PermissionController.class).withRel("permissions");
    }

    public Link linkToGroupPermissions(Long groupId) {
        return linkTo(methodOn(GroupPermissionController.class).listAll(groupId)).withRel("permissions-group");
    }

    public Link linkToAssociatePermissionGroup(Long groupId) {
        return linkTo(methodOn(GroupPermissionController.class).addPermission(groupId, null)).withRel("associate-permission");
    }

    public Link linkToRemovePermissionGroup(Long groupId, Long permissionId) {
        return linkTo(methodOn(GroupPermissionController.class).removePermission(groupId, permissionId)).withRel("remove-permission");
    }

    public Link linkToAssociatePermissionUser(Long userId) {
        return linkTo(methodOn(UserGroupController.class).associateGroup(userId, null)).withRel("associate-permission");
    }

    public Link linkToRemovePermissionUser(Long userId, Long permissionId) {
        return linkTo(methodOn(UserGroupController.class).disassociateGroup(userId, permissionId)).withRel("remove-permission");
    }
    ...
    public Link linkToPhotoProduct(Long productId, Long restaurantId, String rel) {
        return linkTo(methodOn(ProductFileController.class).getPhoto(productId, restaurantId)).withRel(rel);
    }
