...
public interface UserGroupControllerOpenAi {
    ...
    responses = {
        @ApiResponse(responseCode = "200", description = "List of user groups retrieved successfully"),
    ...
    responses = {
        @ApiResponse(responseCode = "204", description = "Group associated successfully"),
        @ApiResponse(responseCode = "400", description = "Invalid user or group ID", content = @Content(schema = @Schema(ref = "Exceptions"))),
        @ApiResponse(responseCode = "404", description = "User or group not found", content = @Content(schema = @Schema(ref = "Exceptions")))
    })
    ...
    responses = {
        ...
        @ApiResponse(responseCode = "400", description = "Invalid user or group ID", content = @Content(schema = @Schema(ref = "Exceptions"))),
        @ApiResponse(responseCode = "404", description = "User, group, or association not found", content = @Content(schema = @Schema(ref = "Exceptions")))
    })
