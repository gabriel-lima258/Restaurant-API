...
public interface StateControllerOpenAi {
    ...
    responses = {
        ...
        @ApiResponse(responseCode = "400", description = "Invalid state ID format", content = @Content(schema = @Schema(ref = "Exceptions"))),
        @ApiResponse(responseCode = "404", description = "State not found", content = @Content(schema = @Schema(ref = "Exceptions")))
    })
    ...
    responses = {
        ...
        @ApiResponse(responseCode = "400", description = "State cannot be deleted (entity in use)", content = @Content(schema = @Schema(ref = "Exceptions"))),
        @ApiResponse(responseCode = "404", description = "State not found", content = @Content(schema = @Schema(ref = "Exceptions")))
    })
