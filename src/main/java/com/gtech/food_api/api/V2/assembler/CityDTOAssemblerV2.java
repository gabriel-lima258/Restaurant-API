...
import com.gtech.food_api.api.V2.controller.CityControllerV2;
 ...
 */
@Component
public class CityDTOAssemblerV2 extends RepresentationModelAssemblerSupport<City, CityDTO>{
     ...
     */
    public CityDTOAssemblerV2() {
        super(CityControllerV2.class, CityDTO.class);
    }
