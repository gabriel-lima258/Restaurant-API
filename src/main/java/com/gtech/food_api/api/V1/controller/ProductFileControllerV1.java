...
import com.gtech.food_api.api.V1.assembler.PhotoProductDTOAssemblerV1;
import com.gtech.food_api.api.V1.dto.PhotoProductDTO;
import com.gtech.food_api.api.V1.dto.input.ProductFileInput;
...
public class ProductFileControllerV1 {
    ...
    @Autowired
    private PhotoProductDTOAssemblerV1 photoProductDTOAssembler;
