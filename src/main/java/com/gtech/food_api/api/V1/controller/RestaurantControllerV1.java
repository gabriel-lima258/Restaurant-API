...
import com.gtech.food_api.api.V1.assembler.RestaurantDTOAssemblerV1;
import com.gtech.food_api.api.V1.assembler.RestaurantSummaryDTOAssemblerV1;
import com.gtech.food_api.api.V1.disassembler.RestaurantInputDisassemblerV1;
...
public class RestaurantControllerV1 {
    ...
    @Autowired
    private RestaurantDTOAssemblerV1 restaurantDTOAssembler;

    @Autowired
    private RestaurantSummaryDTOAssemblerV1 restaurantSummaryDTOAssembler;

    @Autowired
    private RestaurantInputDisassemblerV1 restaurantInputDisassembler;

    @GetMapping
    public ResponseEntity<List<RestaurantSummaryDTO>> listAll(){
        List<RestaurantSummaryDTO> dtoList = restaurantSummaryDTOAssembler.toCollectionDTO(restaurantService.listAll());
